...
class Dataset_supervised_defect(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return image_din, self.image_files[idx], original_image


def test(images_dir, model_weights_path, output_dir,
    ...
    # 테스트 루프
    for idx, (images_din, image_name, original_image) in tqdm(enumerate(dataloader), desc="Testing", total=len(dataloader)):
